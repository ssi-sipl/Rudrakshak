...
(()=>{
    const e = new Error("Cannot find module '@/hooks/useVoiceRecorder'");
...
function MapView({ mode = "operations" }) {
    ...
    const { isListening, isUploading, toggleRecording } = useVoiceRecorder();
...
_s(MapView, "7uTzwEi+jrSX4a4pzvNyfxcOcs0=", false, function() {
    return [
...
//# sourceMappingURL=_de7e5c25._.js.map
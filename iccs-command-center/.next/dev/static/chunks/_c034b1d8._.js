...
"[project]/components/controls/JoystickOverlay.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"use client";
;
function JoystickOverlay({ socket }) {
    _s();
    const containerRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    const leftBaseRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    const leftKnobRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    const rightBaseRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    const rightKnobRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    const keyboardEnabled = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(true);
    const controlRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])({
        forward: 0,
        right: 0,
        up: 0,
        yaw: 0
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "JoystickOverlay.useEffect": ()=>{
            ...
            let offsetY = 0;
            const onMouseDown = {
                "JoystickOverlay.useEffect.onMouseDown": (e)=>{
                    if (e.target.closest(".joystick")) return;
                    dragging = true;
                    offsetX = e.clientX - el.offsetLeft;
                    offsetY = e.clientY - el.offsetTop;
                }
            }["JoystickOverlay.useEffect.onMouseDown"];
            const onMouseMove = {
                "JoystickOverlay.useEffect.onMouseMove": (e)=>{
                    if (!dragging) return;
            ...
            }["JoystickOverlay.useEffect.onMouseMove"];
            const onMouseUp = {
                "JoystickOverlay.useEffect.onMouseUp": ()=>dragging = false
            }["JoystickOverlay.useEffect.onMouseUp"];
    ...
    // 🎯 UPDATE UI KNOBS
    // ---------------------------
    const updateKnob = (knob, x, y)=>{
        if (!knob) return;
        knob.style.transform = `translate(${x}px, ${y}px)`;
    };
    const updateUIFromControl = ()=>{
        const lx = controlRef.current.right * radius;
        const ly = -controlRef.current.forward * radius;
        const rx = controlRef.current.yaw * radius;
        const ry = -controlRef.current.up * radius;
        updateKnob(leftKnobRef.current, lx, ly);
        updateKnob(rightKnobRef.current, rx, ry);
    };
    // ---------------------------
    // 🎮 JOYSTICK (MOUSE)
    // ---------------------------
    const setupJoystick = (base, knob, type)=>{
        let dragging = false;
        ...
        window.addEventListener("pointerup", ()=>{
            dragging = false;
            if (type === "left") {
                controlRef.current.forward = 0;
                controlRef.current.right = 0;
            } else {
                controlRef.current.up = 0;
        ...
        window.addEventListener("pointermove", (e)=>{
            ...
            const ny = ly / radius;
            if (type === "left") {
                controlRef.current.forward = -ny;
                controlRef.current.right = nx;
            } else {
                controlRef.current.up = -ny;
                controlRef.current.yaw = nx;
            }
        });
    };
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "JoystickOverlay.useEffect": ()=>{
            if (leftBaseRef.current && leftKnobRef.current) {
                setupJoystick(leftBaseRef.current, leftKnobRef.current, "left");
            }
            if (rightBaseRef.current && rightKnobRef.current) {
                setupJoystick(rightBaseRef.current, rightKnobRef.current, "right");
            }
        }
    }["JoystickOverlay.useEffect"], []);
    // ---------------------------
    // ⌨️ KEYBOARD CONTROL + UI SYNC
    // ---------------------------
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "JoystickOverlay.useEffect": ()=>{
            const keys = {};
            const down = {
                "JoystickOverlay.useEffect.down": (e)=>{
                    keys[e.key.toLowerCase()] = true;
                }
            }["JoystickOverlay.useEffect.down"];
            const up = {
                "JoystickOverlay.useEffect.up": (e)=>{
                    keys[e.key.toLowerCase()] = false;
                }
            }["JoystickOverlay.useEffect.up"];
            const loop = setInterval({
                "JoystickOverlay.useEffect.loop": ()=>{
                    if (!keyboardEnabled.current) return;
                    controlRef.current.forward = (keys["w"] ? 1 : 0) - (keys["s"] ? 1 : 0);
                    controlRef.current.right = (keys["d"] ? 1 : 0) - (keys["a"] ? 1 : 0);
                    controlRef.current.up = (keys["arrowup"] ? 1 : 0) - (keys["arrowdown"] ? 1 : 0);
                    controlRef.current.yaw = (keys["arrowright"] ? 1 : 0) - (keys["arrowleft"] ? 1 : 0);
                    updateUIFromControl();
                }
            }["JoystickOverlay.useEffect.loop"], 50);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "JoystickOverlay.useEffect": ()=>{
            ...
            const interval = setInterval({
                "JoystickOverlay.useEffect.interval": ()=>{
                    socket.emit("drone-control", controlRef.current);
                }
            }["JoystickOverlay.useEffect.interval"], 50);
            return ({
                "JoystickOverlay.useEffect": ()=>clearInterval(interval)
            })["JoystickOverlay.useEffect"];
        }
    }["JoystickOverlay.useEffect"], [
        socket
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ref: containerRef,
        className: "fixed top-40 left-10 z-[2000] bg-black/80 backdrop-blur p-4 rounded-xl border border-gray-700 flex gap-6 shadow-2xl",
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: "Movement (WASD)"
                    }, void 0, false, {
                        fileName: "[project]/components/controls/JoystickOverlay.tsx",
                        lineNumber: 217,
                        columnNumber: 9
                    }, this),
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ref: leftBaseRef,
                        className: "joystick w-32 h-32 bg-gray-800 rounded-full relative",
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ref: leftKnobRef,
                            className: "w-12 h-12 bg-white rounded-full absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2"
                        }, void 0, false, {
                            fileName: "[project]/components/controls/JoystickOverlay.tsx",
                            lineNumber: 222,
                            columnNumber: 11
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                        onClick: ()=>socket.emit("orient-north"),
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                        onClick: ()=>{
                            keyboardEnabled.current = !keyboardEnabled.current;
                        },
                        className: "bg-gray-700 hover:bg-gray-800 px-4 py-2 rounded text-white text-sm",
                        children: "⌨️ Toggle Keyboard"
                    }, void 0, false, {
                        fileName: "[project]/components/controls/JoystickOverlay.tsx",
                        lineNumber: 254,
                        columnNumber: 9
...
_s(JoystickOverlay, "wA6K1xG6oF5LBbGmDLccfPZm+UU=");
_c = JoystickOverlay;
var _c;
__turbopack_context__.k.register(_c, "JoystickOverlay");
                        ...
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(Tooltip, {
                            ...
                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    droneOnSensor && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
function TelemetryWindow({ telemetry, isOpen, onClose, onDropPayload, onRecall }) {
    ...
    const handleOpenVideoFeed = async ()=>{
        ...
        try {
            const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$rtsp$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["openRtspBySensor"])(telemetry.videoLink);
            if (!res.success) {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/jsx-dev-runtime.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/index.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$controls$2f$JoystickOverlay$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/controls/JoystickOverlay.tsx [app-client] (ecmascript)");
...
function MapView() {
    ...
    const handleAlertDispatch = (alert)=>{
        ...
        const dronesInArea = dronesRef.current.filter((d)=>d.areaId === sensor.areaId);
    ...
    const dronesInSameArea = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "MapView.useMemo[dronesInSameArea]": ()=>{
            ...
            return drones.filter({
                "MapView.useMemo[dronesInSameArea]": (drone)=>{
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
        children: [
            ...
            socket && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$controls$2f$JoystickOverlay$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                socket: socket
            }, void 0, false, {
                fileName: "[project]/components/map-view.tsx",
                lineNumber: 1436,
...
//# sourceMappingURL=_c034b1d8._.js.map
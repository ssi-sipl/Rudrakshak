...
function ViewSmartMeterPage() {
    ...
    const fetchSensorDetails = async ()=>{
        ...
        setError(null);
        try {
            const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$sensors$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getSensorById"])(params.id, true);
    ...
    const handleDelete = async ()=>{
        ...
        setDeleting(true);
        try {
            const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$sensors$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["deleteSensor"])(sensor.id);
            if (response.success) {
                toast({
                    title: "Success",
...
_s(ViewSmartMeterPage, "dNFD/XfRc3W4awysPEN821sx94w=", false, function() {
    return [
...
//# sourceMappingURL=_3be43e20._.js.map
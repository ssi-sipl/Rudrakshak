...
"[project]/app/(protected)/users/[id]/edit/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function EditUserPage() {
    ...
    const fetchUserDetails = async ()=>{
        ...
        setError(null);
        try {
            const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$user$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getUserById"])(params.id);
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$user$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["updateUser"])(params.id, {
                name: formData.name,
                role: formData.role,
    ...
    const handleResetPassword = async ()=>{
        ...
        try {
            const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$user$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["resetUserPassword"])(params.id, trimmedPassword);
            if (response.success) {
                toast({
...
_s(EditUserPage, "LbpsJO9PVihRqTtehsBbJjincI0=", false, function() {
    return [
...
//# sourceMappingURL=_b595ac71._.js.map
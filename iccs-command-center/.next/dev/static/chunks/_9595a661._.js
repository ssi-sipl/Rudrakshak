...
function DashboardSidebar({ isOpen, onToggle }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "DashboardSidebar.useEffect": ()=>{
            ...
            // ---------- ALERTS ----------
            console.log(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$alert$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Alert"]);
            socket.on("alert_active", {
                "DashboardSidebar.useEffect": (alert)=>{
                    setAlerts({
                        "DashboardSidebar.useEffect": (prev)=>{
                            if (prev.some({
                                "DashboardSidebar.useEffect": (a)=>a.id === alert.id
                            }["DashboardSidebar.useEffect"])) return prev;
                            return [
                                alert,
                                ...prev
...
//# sourceMappingURL=_9595a661._.js.map
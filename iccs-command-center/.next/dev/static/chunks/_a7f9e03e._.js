...
"[project]/app/(protected)/drones/[id]/control/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function DroneControlPage() {
    ...
    const [telemetry, setTelemetry] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    const droneRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    // ── Load this drone's last-known record (name, videoLink, targetAltitude) ──
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "DroneControlPage.useEffect": ()=>{
            let cancelled = false;
            const load = {
                "DroneControlPage.useEffect.load": async ()=>{
                    setLoading(true);
                    setError(null);
                    try {
                        ...
                        if (res.success && res.data) {
                            const found = res.data.find({
                                "DroneControlPage.useEffect.load.found": (d)=>d.id === droneId
                            }["DroneControlPage.useEffect.load.found"]);
                            if (found) {
                                setDrone(found);
            ...
            }["DroneControlPage.useEffect.load"];
            if (droneId) load();
            return ({
                "DroneControlPage.useEffect": ()=>{
                    cancelled = true;
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "DroneControlPage.useEffect": ()=>{
            ...
            socketRef.current = s;
            s.on("connect", {
                "DroneControlPage.useEffect": ()=>setSocketConnected(true)
            }["DroneControlPage.useEffect"]);
            s.on("disconnect", {
                "DroneControlPage.useEffect": ()=>setSocketConnected(false)
            }["DroneControlPage.useEffect"]);
            s.on("drone_telemetry", {
                "DroneControlPage.useEffect": (t)=>{
            ...
            s.on("drone_position", {
                "DroneControlPage.useEffect": (pos)=>{
                    if (pos.id !== droneId) return; // ignore positions for other drones
                    setTelemetry({
                        "DroneControlPage.useEffect": (prev)=>prev ? {
                                ...prev,
                                lat: pos.lat,
                                lng: pos.lng,
...
_s(DroneControlPage, "kvLO0dxI6RGnZL+zLiYmxWPEJvw=", false, function() {
    return [
...
_c = DroneControlPage;
var _c;
__turbopack_context__.k.register(_c, "DroneControlPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_a7f9e03e._.js.map
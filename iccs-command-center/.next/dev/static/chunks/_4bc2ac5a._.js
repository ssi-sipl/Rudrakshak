...
function DashboardHeader() {
    ...
    const { refreshUser } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$context$2f$AuthContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"])();
    const { user, fetchUser } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$context$2f$UserContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useUser"])();
    const navItems = [
        {
...
const mockAlerts = [
    {
        ...
        message: "Person detected near North Gate.",
        status: "ACTIVE",
    ...
    },
    {
        ...
        message: "Vehicle detected at South Entrance.",
        status: "SENT",
        createdAt: "2026-07-14T09:30:00Z",
        decidedAt: "2026-07-14T09:31:00Z",
        decision: "send_drone:drone-2",
        time: "09:30 AM",
        metadata: {
            confidence: 94
        },
    ...
    },
    {
        ...
        message: "Animal movement detected.",
        status: "NEUTRALISED",
        createdAt: "2026-07-13T18:10:00Z",
        decidedAt: "2026-07-13T18:15:00Z",
...
async function getAllAlerts(params) {
    ...
    if (params?.sortBy) {
        data.sort((a, b)=>{
            const first = a[params.sortBy] || "";
            const second = b[params.sortBy] || "";
...
async function getActiveAlerts() {
    ...
    return {
        success: true,
        count: mockAlerts.filter((a)=>a.status === "ACTIVE").length,
        data: mockAlerts.filter((a)=>a.status === "ACTIVE")
    };
}
async function getAlertsBySensor(sensorDbId) {
    await new Promise((r)=>setTimeout(r, 200));
    const alerts = mockAlerts.filter((a)=>a.sensorDbId === sensorDbId);
    return {
        success: true,
        count: alerts.length,
        data: alerts
...
async function sendDroneForAlert(alertId, droneId) {
    ...
    alert.decision = `send_drone:${droneId}`;
    return {
        success: true,
        data: {
            alert,
...
async function neutraliseAlert(alertId, reason) {
    ...
    alert.status = "NEUTRALISED";
    alert.decidedAt = new Date().toISOString();
    alert.decision = reason ? `neutralised:${reason}` : "neutralised";
    return {
        success: true,
        data: alert,
        message: "Alert neutralised successfully"
    };
}
...
async function neutraliseAllActiveAlerts(reason) {
    ...
    return {
        success: true,
        message: `${count} alert(s) neutralised successfully`
    };
}
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
...
"[project]/lib/simulator/simulator.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";

// ==============================================
// DRONE SIMULATOR
// Frontend-only Drone Flight Simulator
// ==============================================
__turbopack_context__.s([
    "droneSimulator",
    ()=>droneSimulator
...
class DroneSimulator {
    ...
    // ============================================
    registerDrone(data) {
        if (this.drones.has(data.droneId)) return;
        this.drones.set(data.droneId, {
    ...
    // ============================================
    sendDrone(data) {
        const drone = this.drones.get(data.droneId);
        if (!drone) return;
        console.log("SEND DRONE", data);
        if (drone.status === "flying") return;
        drone.targetLatitude = data.targetLatitude;
        drone.targetLongitude = data.targetLongitude;
        drone.status = "taking_off";
        drone.mode = "AUTO";
        drone.targetReached = false;
    ...
    recallDrone(droneId) {
        ...
        if (!drone) return;
        drone.targetLatitude = drone.homeLatitude;
        drone.targetLongitude = drone.homeLongitude;
    ...
    patrolDrone(droneId) {
        ...
        if (!drone) return;
        const offset = 0.001;
        drone.targetLatitude = drone.homeLatitude + offset;
        drone.targetLongitude = drone.homeLongitude + offset;
        drone.status = "taking_off";
        drone.mode = "AUTO";
    }
    // ============================================
    ...
    // ============================================
    registerFleet(drones) {
        console.log("Registering fleet:", drones);
        ...
        console.log("Simulator drones:", this.getAllDrones());
    }
    // implemented in Part 2
    updateDrone(drone) {
        if (!drone.targetLatitude || !drone.targetLongitude) return;
        // -----------------------------
        // Takeoff
        // -----------------------------
        if (drone.status === "taking_off") {
            drone.altitude += 2;
            if (drone.altitude >= 40) {
                drone.altitude = 40;
                drone.status = "flying";
            }
            this.emitTelemetry(drone);
            return;
        }
        // -----------------------------
        // Flying / Returning
        ...
        if (drone.status === "flying" || drone.status === "returning") {
            const distance = this.distanceMeters(drone.latitude, drone.longitude, drone.targetLatitude, drone.targetLongitude);
            if (distance < 3) {
                // reached target
                if (drone.mode === "RTL") {
                    drone.altitude = 0;
                    ...
                    drone.status = "reached";
                    drone.speed = 0;
                    drone.targetReached = true;
                }
            ...
            // Move drone
            drone.latitude = this.moveTowards(drone.latitude, drone.targetLatitude, 0.02);
            drone.longitude = this.moveTowards(drone.longitude, drone.targetLongitude, 0.02);
            drone.speed = 10 + Math.random() * 4;
            drone.heading = this.calculateHeading(drone.latitude, drone.longitude, drone.targetLatitude, drone.targetLongitude);
            drone.battery = Math.max(5, drone.battery - 0.02);
            this.emitPosition(drone);
            this.emitTelemetry(drone);
            return;
        }
        // -----------------------------
        // Reached target
        // -----------------------------
        if (drone.status === "reached") {
            drone.battery = Math.max(5, drone.battery - 0.005);
            this.emitTelemetry(drone);
        }
    }
    // ============================================
    // HELPERS
    // ============================================
    moveTowards(current, target, factor) {
    ...
    // ============================================
    emitTelemetry(drone) {
        this.emit("drone_telemetry", {
            droneDbId: drone.droneId,
            droneId: drone.droneId,
            lat: drone.latitude,
            lng: drone.longitude,
            alt: drone.altitude,
            battery: Number(drone.battery.toFixed(1)),
            speed: Number(drone.speed.toFixed(1)),
            heading: Math.round(drone.heading),
            mode: drone.mode,
            status: drone.status === "ground" ? "ground" : drone.status === "reached" ? "reached" : "on_air",
            targetLat: drone.targetLatitude ?? null,
            targetLng: drone.targetLongitude ?? null,
            targetDistance: null,
            satellites: 12,
            gpsFix: "3D",
            windSpeed: 3,
...
"[project]/lib/api/droneos.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$simulator$2f$simulator$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/simulator/simulator.ts [app-client] (ecmascript)");
;
// Register every drone with simulator
const mockDrones = [
    {
        id: "drone-1",
        droneId: "DRONE-001",
        droneOSName: "Alpha Drone",
        droneType: "Quadcopter",
        videoLink: "rtsp://drone1/live",
        gpsFix: "3D Fix",
        minHDOP: 0.7,
        minSatCount: 8,
        maxWindSpeed: 12,
    ...
    },
    {
        id: "drone-2",
        droneId: "DRONE-002",
        droneOSName: "Bravo Drone",
        droneType: "Hexacopter",
        videoLink: "rtsp://drone2/live",
        gpsFix: "3D Fix",
        minHDOP: 0.8,
        minSatCount: 8,
        maxWindSpeed: 14,
    ...
    },
    {
        id: "drone-3",
        droneId: "DRONE-003",
        droneOSName: "Charlie Drone",
        droneType: "Quadcopter",
        videoLink: "rtsp://drone3/live",
        gpsFix: "3D Fix",
        minHDOP: 0.9,
        minSatCount: 7,
        maxWindSpeed: 10,
    ...
    },
    {
        id: "drone-4",
        droneId: "DRONE-004",
        droneOSName: "Delta Drone",
        droneType: "Quadcopter",
        videoLink: "rtsp://drone4/live",
        gpsFix: "3D Fix",
        minHDOP: 0.8,
        minSatCount: 7,
        maxWindSpeed: 11,
    ...
    },
    {
        id: "drone-5",
        droneId: "DRONE-005",
        droneOSName: "Echo Drone",
        droneType: "Hexacopter",
        videoLink: "rtsp://drone5/live",
        gpsFix: "3D Fix",
        minHDOP: 0.7,
        minSatCount: 9,
        maxWindSpeed: 13,
    ...
    },
    {
        id: "drone-6",
        droneId: "DRONE-006",
        droneOSName: "Falcon Drone",
        droneType: "Quadcopter",
        videoLink: "rtsp://drone6/live",
        gpsFix: "3D Fix",
        minHDOP: 0.9,
        minSatCount: 7,
        maxWindSpeed: 10,
    ...
    },
    {
        id: "drone-7",
        droneId: "DRONE-007",
        droneOSName: "Guardian Drone",
        droneType: "Quadcopter",
        videoLink: "rtsp://drone7/live",
        gpsFix: "3D Fix",
        minHDOP: 0.8,
        minSatCount: 8,
        maxWindSpeed: 12,
    ...
    },
    {
        id: "drone-8",
        droneId: "DRONE-008",
        droneOSName: "Ranger Drone",
        droneType: "Hexacopter",
        videoLink: "rtsp://drone8/live",
        gpsFix: "3D Fix",
        minHDOP: 0.7,
        minSatCount: 9,
        maxWindSpeed: 14,
...
__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$simulator$2f$simulator$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["droneSimulator"].registerFleet(mockDrones.map((drone)=>({
        droneId: drone.droneId,
        latitude: drone.latitude ?? null,
        longitude: drone.longitude ?? null
    })));
async function getAllDroneOS(params) {
    ...
    if (params?.areaId) {
        data = data.filter((d)=>d.areaId === params.areaId);
    }
    if (params?.search) {
        const search = params.search.toLowerCase();
        data = data.filter((d)=>d.droneId.toLowerCase().includes(search) || d.droneOSName.toLowerCase().includes(search) || d.droneType.toLowerCase().includes(search) || d.gpsName.toLowerCase().includes(search));
    }
    return {
        success: true,
        data,
...
async function getDroneStats() {
    ...
    return {
        ...
        data: {
            ...
            assigned: mockDrones.filter((d)=>d.areaId !== null).length,
            unassigned: mockDrones.filter((d)=>d.areaId === null).length
        }
    };
}
...
async function getDronesByArea(areaId, includeArea = false) {
    await new Promise((r)=>setTimeout(r, 300));
    const drones = mockDrones.filter((d)=>d.areaId === areaId);
    return {
        success: true,
        count: drones.length,
        data: drones
...
async function createDroneOS(droneData) {
    await new Promise((r)=>setTimeout(r, 300));
    const newDrone = {
        id: `drone-${mockDrones.length + 1}`,
        ...droneData,
        videoLink: droneData.videoLink || null,
        areaId: droneData.areaId || null,
        area: droneData.areaId === "area-1" ? {
            id: "area-1",
            areaId: "AREA-001",
            name: "North Zone",
            latitude: 28.6139,
...
async function updateDroneOS(id, droneData) {
    ...
    if (droneData.areaId !== undefined) {
        if (droneData.areaId === "area-1") {
            drone.area = {
                id: "area-1",
                areaId: "AREA-001",
                name: "North Zone",
        ...
        } else if (droneData.areaId === "area-2") {
            drone.area = {
                id: "area-2",
                areaId: "AREA-002",
                name: "South Zone",
        ...
        } else if (droneData.areaId === "area-3") {
            drone.area = {
                id: "area-3",
                areaId: "AREA-003",
                name: "East Zone",
...
"[project]/lib/api/rtsp.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function openRtspBySensor(sensorDbId, timeoutMs = 10000) {
    ...
    console.log("[MOCK] Opening RTSP for sensor:", sensorDbId);
    return {
        success: true,
        data: {
        ...
        message: "RTSP stream opened successfully (Demo)"
    };
}
async function openRtsp(params, timeoutMs = 10000) {
    ...
    console.log("[MOCK] Opening RTSP:", params);
    return {
        success: true,
        data: {
            pid: Math.floor(Math.random() * 10000),
            sensorDbId: params.sensorDbId
        },
        message: "RTSP stream opened successfully (Demo)"
    };
}
async function stopRtsp(payload) {
    await delay();
    if (!payload.sensorDbId && !payload.pid) {
        return {
            success: false,
            error: "Provide sensorDbId or pid"
        };
    }
    console.log("[MOCK] Stopping RTSP:", payload);
    return {
        success: true,
        message: "RTSP stream stopped successfully (Demo)"
    };
}
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
...
"[project]/lib/api/droneCommand.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";

// Mock Drone Command API
__turbopack_context__.s([
    "dronePatrol",
    ()=>dronePatrol,
    "dropPayload",
...
async function sendDrone(payload) {
    await new Promise((r)=>setTimeout(r, 400));
    const drone = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$simulator$2f$simulator$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["droneSimulator"].getAllDrones().find((d)=>d.droneId === payload.droneDbId);
    if (!drone) {
        return {
            success: false,
            error: "Drone not found"
    ...
    __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$simulator$2f$simulator$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["droneSimulator"].sendDrone({
        droneId: payload.droneDbId,
...
async function dropPayload(payload) {
    ...
    return {
        success: true,
        message: "Payload dropped successfully"
    };
}
async function recallDrone(payload) {
    await new Promise((r)=>setTimeout(r, 300));
    __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$simulator$2f$simulator$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["droneSimulator"].recallDrone(payload.droneDbId);
    return {
        success: true,
        message: "Drone recalled"
    };
}
async function dronePatrol(payload) {
    await new Promise((r)=>setTimeout(r, 300));
    __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$simulator$2f$simulator$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["droneSimulator"].patrolDrone(payload.droneDbId);
    return {
        success: true,
...
"[project]/hooks/use-alert-sound.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function useAlertSound({ soundPath = "/siren-alert.mp3", throttleMs = 8000 } = {}) {
    ...
    const lastPlayedRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(0);
    ...
    const playAlertSound = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
    ...
    const stopAlertSound = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
...
var __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$use$2d$alert$2d$sound$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/hooks/use-alert-sound.ts [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
"use client";
;
...
function DashboardSidebar({ isOpen, onToggle }) {
    ...
    const { playAlertSound } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$use$2d$alert$2d$sound$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAlertSound"])({
    ...
    const [dronesList, setDronesList] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    const [dronesLoading, setDronesLoading] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    const [dronesError, setDronesError] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    const [alertsLoading2, setAlertsLoading2] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    const [alertsError2, setAlertsError2] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    const [neutraliseAllConfirmOpen, setNeutraliseAllConfirmOpen] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    ...
    const [dronesLoading2, setDronesLoading2] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    const [dronesError2, setDronesError2] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    const [selectedPatrolDroneId, setSelectedPatrolDroneId] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("");
    const [patrolConfirmOpen, setPatrolConfirmOpen] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    const [patrolLoading, setPatrolLoading] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "DashboardSidebar.useEffect": ()=>{
            const loadAlerts = {
                "DashboardSidebar.useEffect.loadAlerts": async ()=>{
                    ...
                    try {
                        ...
                        if (res.success && res.data) {
                            ...
                            setAlerts([]);
                            setAlertsError2(res.error || "Failed to load alerts");
                        }
                    } catch (err) {
                        setAlerts([]);
                        setAlertsError2(err instanceof Error ? err.message : "Failed to load alerts");
                    } finally{
                        setAlertsLoading2(false);
                    }
                }
            }["DashboardSidebar.useEffect.loadAlerts"];
            loadAlerts();
        }
    }["DashboardSidebar.useEffect"], []);
    // useEffect(() => {
    ...
    const handleOpenVideoFeed = async ()=>{
        ...
        try {
            const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$rtsp$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["openRtspBySensor"])(selectedAlert.sensor.id);
            if (res?.success) {
    ...
    const handleNeutralise = async ()=>{
        ...
        setActionLoading(true);
        try {
            const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$alerts$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["neutraliseAlert"])(selectedAlert.id, "Manual neutralisation");
            if (!res.success) {
    ...
    const handleNeutraliseAll = async ()=>{
        ...
        const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$alerts$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["neutraliseAllActiveAlerts"])("manual_clear");
        if (!res.success) {
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("section", {
                        ...
                        children: [
                            ...
                            dronesLoading && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            !dronesLoading && dronesError && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                            ...
                            !dronesLoading && !dronesError && dronesList.length === 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                            ...
                            !dronesLoading && !dronesError && dronesList.length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
    ...
    ${selectedPatrolDroneId === drone.id ? "border-blue-500 bg-blue-950/40" : "border-[#333] bg-[#222] hover:border-[#4A9FD4]"}`,
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("section", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    alertsLoading2 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    !alertsLoading2 && alertsError2 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                    ...
                                    !alertsLoading2 && !alertsError2 && alerts.length === 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                    ...
                                    !alertsLoading2 && !alertsError2 && alerts.length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        className: "space-y-3",
                                                ...
                                                children: [
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                        onClick: async (e)=>{
                                                            e.stopPropagation();
                                                            try {
                                                                const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$alerts$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["neutraliseAlert"])(alert.id, "manual_clear");
                                                                if (!res.success) {
                                                                    throw new Error(res.error || "Failed to neutralise alert");
                                                                }
                                                                toast({
            ...
            isModalOpen && selectedAlert && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                ...
                                dronesLoading2 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    className: "flex items-center gap-2 text-xs text-gray-400",
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$loader$2d$circle$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Loader2$3e$__["Loader2"], {
                                            className: "h-3 w-3 animate-spin text-[#4A9FD4]"
                                ...
                                !dronesLoading2 && dronesError2 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                    className: "text-xs text-red-500",
                                ...
                                !dronesLoading2 && !dronesError2 && drones.length === 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                    className: "text-xs text-gray-500",
                                ...
                                !dronesLoading2 && !dronesError2 && drones.length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$select$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Select"], {
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$select$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SelectContent"], {
                                            ...
                                            children: drones.map((drone)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$select$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SelectItem"], {
                                                    value: drone.id,
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Button"], {
                                    ...
                                    children: videoLoading ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$loader$2d$circle$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Loader2$3e$__["Loader2"], {
            ...
            patrolConfirmOpen && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Button"], {
                                    ...
                                    onClick: async ()=>{
                                        try {
                                            ...
                                            const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$droneCommand$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["dronePatrol"])({
            ...
            neutraliseAllConfirmOpen && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "fixed inset-0 z-50 flex items-center justify-center bg-black/60",
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    className: "w-full max-w-sm rounded-lg border border-[#333] bg-[#111] p-5",
                    children: [
...
_s(DashboardSidebar, "iZIv90L4sIQKbfv+D0PCadobjcw=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$use$2d$toast$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useToast"],
        __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$use$2d$alert$2d$sound$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAlertSound"]
    ];
});
_c = DashboardSidebar;
var _c;
...
//# sourceMappingURL=_4bc2ac5a._.js.map
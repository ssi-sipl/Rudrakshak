...
"[project]/components/smartmeter/mediaConverterCard.tsx [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {

// "use client";
// import { Trash2, Cpu } from "lucide-react";
// import { Input } from "@/components/ui/input";
// import { Label } from "@/components/ui/label";
// import LedMapping, { LedMappingData } from "./ledMapping";
// interface MediaConverter {
//   mediaConverterId: string;
//   left1Label: any;
//   left2Label: any;
//   left3Label: any;
//   right1Label: any;
...
//   onMappingChange: (mapping: LedMappingData) => void;
//   onRemove: () => void;
//   removable: boolean;
// }
// export default function MediaConverterCard({
//   index,
//   converter,
//   onIdChange,
//   onMappingChange,
...
// }: Props) {
//   return (
//     <div className="flex flex-col gap-4 rounded-xl border border-zinc-800 bg-zinc-900/90 p-4 transition-colors duration-200 hover:border-red-700/40 md:flex-row md:items-center md:gap-6">
//       {/* Left: identity + ID */}
//       <div className="flex shrink-0 items-center gap-3 md:w-56">
//         <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-lg border border-zinc-700 bg-zinc-950 text-red-500">
...
//       </div>
//       {/* Divider */}
//       <div className="hidden h-12 w-px shrink-0 bg-zinc-800 md:block" />
//       {/* Right: LED mapping */}
//       <div className="min-w-0 flex-1">
//         <LedMapping
//           value={{
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            ...
            if (response.success) {
                ...
                if (response.error?.toLowerCase().includes("smart meter")) {
                    alert(response.error);
                    return;
                }
                alert(response.error || "Failed to update Smart Meter");
            }
        } catch (err) {
            toast({
                title: "Error",
...
//# sourceMappingURL=_0eae3013._.js.map
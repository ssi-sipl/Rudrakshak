...
var __TURBOPACK__imported__module__$5b$project$5d2f$Rayonix$2f$iccs$2d$command$2d$center$2f$lib$2f$api$2f$rtsp$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Rayonix/iccs-command-center/lib/api/rtsp.ts [app-ssr] (ecmascript)");
"use client";
;
;
;
...
function TelemetryWindow({ telemetry, isOpen, onClose, onDropPayload, onRecall }) {
    ...
    const handleOpenVideoFeed = async ()=>{
        ...
        try {
            const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Rayonix$2f$iccs$2d$command$2d$center$2f$lib$2f$api$2f$rtsp$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["openRtsp"])({
...
function MapView({ mode = "operations" }) {
    ...
    const handleOpenVideoFeed = async ()=>{
        ...
        try {
            setActionLoading(true);
            const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Rayonix$2f$iccs$2d$command$2d$center$2f$lib$2f$api$2f$rtsp$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["openRtspBySensor"])(selectedSensor.id);
            if (res && res.success) {
...
//# sourceMappingURL=Rayonix_iccs-command-center_278291d2._.js.map
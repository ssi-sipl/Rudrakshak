...
function UserListPage() {
    ...
    const { user: currentUser } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$context$2f$UserContext$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useUser"])();
    ...
    const fetchUsers = async ()=>{
        setLoading(true);
        try {
            const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$user$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getUsers"])({
                page,
                limit,
    ...
    const handleDelete = async (id, userName)=>{
        setDeleting(id);
        try {
            const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$user$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["deleteUser"])(id);
            if (response.success) {
...
//# sourceMappingURL=_2293758c._.js.map
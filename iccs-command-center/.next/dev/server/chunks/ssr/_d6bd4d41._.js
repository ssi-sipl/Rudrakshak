...
const mockMaps = [
    {
        id: "map-1",
        name: "North Zone",
        description: "Primary surveillance area",
        tileRoot: "/maps",
        minZoom: 15,
        maxZoom: 19,
        north: 28.6200,
    ...
    },
    {
        id: "map-2",
        name: "South Zone",
        description: "Backup surveillance map",
        tileRoot: "/maps",
        minZoom: 14,
        maxZoom: 18,
        north: 28.5420,
    ...
    },
    {
        id: "map-3",
        name: "East Zone",
        description: "Downloading demo map",
        tileRoot: "/maps",
        minZoom: 13,
        maxZoom: 17,
        north: 28.7100,
...
async function getActiveMap() {
    ...
    const activeMap = mockMaps.find((m)=>m.isActive) || null;
    return {
        success: true,
        data: activeMap
    };
...
async function deleteMap(id) {
    await new Promise((r)=>setTimeout(r, 300));
    const index = mockMaps.findIndex((m)=>m.id === id);
    if (index === -1) {
        return {
            success: false,
            error: "Map not found"
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(MapContainer, {
                ...
                children: [
                    ...
                    visibleSensors.map((sensor)=>{
                        ...
                        const isPlanningTarget = battlePlannerMode && selectedTargetSensor?.id === sensor.id;
                        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(Marker, {
                            ...
                            icon: getMemoizedSensorIcon(sensor, hasActiveAlert, droneOnSensor, sensor.id === focusedSensorId || isPlanningTarget),
                            ref: (ref)=>{
                                if (ref) {
                            ...
                            eventHandlers: {
                                click: ()=>{
                                    if (battlePlannerMode) {
                                        onSelectTargetSensor?.(sensor);
                                        return;
                                    }
                                    openSensor(sensor);
                                }
                    ...
                    visibleDrones.map((drone)=>{
                        ...
                        {
                            battlePlannerMode && selectedPlanningDrone && selectedTargetSensor && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(Polyline, {
                                positions: [
                                    [
                                        selectedPlanningDrone.latitude,
                                        selectedPlanningDrone.longitude
                                    ],
                                    [
                                        selectedTargetSensor.latitude,
                                        selectedTargetSensor.longitude
                                    ]
                                ],
                                pathOptions: {
                                    color: "#00ffff",
                        ...
                        {
                            battlePlannerMode && selectedTargetSensor && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(CircleMarker, {
                                center: [
                                    selectedTargetSensor.latitude,
                                    selectedTargetSensor.longitude
                                ],
...
"[project]/components/battle-planner/battle-planner-panel.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"use client";
;
function BattlePlannerPanel({ drones, selectedDrone, onSelect }) {
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "absolute bottom-4 left-1/2 z-[1000] flex -translate-x-1/2 gap-3 rounded-xl border border-[#333] bg-[#111]/95 p-3 backdrop-blur-md",
        children: drones.map((drone)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                onClick: ()=>onSelect(drone),
                className: `w-44 rounded-lg border p-3 text-left transition ${selectedDrone?.id === drone.id ? "border-blue-500 bg-blue-900/30" : "border-[#333] hover:border-[#555]"}`,
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "font-semibold text-white",
                        children: drone.droneOSName
                    }, void 0, false, {
                        fileName: "[project]/components/battle-planner/battle-planner-panel.tsx",
                        lineNumber: 28,
                        columnNumber: 11
                    }, this),
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
function useVoiceRecorder() {
    ...
    const stopTimeoutRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useRef"])(null);
   ...
   */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
    ...
    const sendAudioToBackend = async ()=>{
        try {
            ...
            const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$voice$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["sendVoiceCommand"])(audioBlob);
...
"[project]/components/battle-planner/mission-analysis.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/server/route-modules/app-page/vendored/ssr/react-jsx-dev-runtime.js [app-ssr] (ecmascript)");
;
function MissionAnalysis({ drone, sensor, onStartAttack }) {
    if (!drone || !sensor) return null;
    const distance = Math.sqrt(Math.pow(drone.latitude - sensor.latitude, 2) + Math.pow(drone.longitude - sensor.longitude, 2)) * 111000;
    const eta = distance / 12;
    const batteryUsed = distance / 500;
    const batteryRemaining = Math.max(0, 100 - batteryUsed);
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "absolute top-5 right-5 z-[1000] w-80 rounded-xl border border-cyan-500/30 bg-[#111827]/95 backdrop-blur-md shadow-xl",
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "border-b border-cyan-500/20 p-4",
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("h2", {
                    className: "text-lg font-bold text-cyan-400",
                    children: "Mission Analysis"
                }, void 0, false, {
                    fileName: "[project]/components/battle-planner/mission-analysis.tsx",
                    lineNumber: 33,
                    columnNumber: 9
                }, this)
            }, void 0, false, {
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                    ...
                    className: "w-full rounded-lg py-3 font-semibold text-white transition hover:bg-blue-600",
                    children: "START DEMO ATTACK"
                }, void 0, false, {
                    fileName: "[project]/components/battle-planner/mission-analysis.tsx",
                    lineNumber: 72,
                    columnNumber: 3
...
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$battle$2d$planner$2f$battle$2d$planner$2d$panel$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/battle-planner/battle-planner-panel.tsx [app-ssr] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$battle$2d$planner$2f$mission$2d$analysis$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/battle-planner/mission-analysis.tsx [app-ssr] (ecmascript)");
"use client";
;
;
;
...
;
;
const drones = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$droneos$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getAllDroneOS"])();
...
function MapView({ mode = "operations" }) {
    ...
    const { isListening, isUploading, toggleRecording } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$use$2d$voice$2d$recorder$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useVoiceRecorder"])();
    ...
    const [selectedTargetSensor, setSelectedTargetSensor] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    const [selectedPlanningDrone, setSelectedPlanningDrone] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const loadDrones = async ()=>{
            ...
            try {
                ...
                if (res.success && res.data) {
                    setDrones(res.data);
                    if (mode === "battle-planner" && res.data.length > 0) {
                        setSelectedPlanningDrone(res.data[0]);
                    }
                    __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$simulator$2f$simulator$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["droneSimulator"].registerFleet(res.data.map((drone)=>({
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        const handleTelemetry = (telemetry)=>{
            setDroneTelemetryData((prev)=>({
                    ...prev,
                    [telemetry.droneId]: telemetry
                }));
        };
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$simulator$2f$simulator$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["droneSimulator"].subscribe("drone_position", handlePosition);
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$simulator$2f$simulator$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["droneSimulator"].subscribe("drone_telemetry", handleTelemetry);
        return ()=>{
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$simulator$2f$simulator$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["droneSimulator"].unsubscribe("drone_position", handlePosition);
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$simulator$2f$simulator$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["droneSimulator"].unsubscribe("drone_telemetry", handleTelemetry);
        };
    }, []);
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Fragment"], {
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$map$2d$renderer$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"], {
                ...
                selectedPlanningDrone: selectedPlanningDrone,
                battlePlannerMode: mode === "battle-planner",
                selectedTargetSensor: selectedTargetSensor,
                onSelectTargetSensor: setSelectedTargetSensor,
            ...
            mode === "battle-planner" && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$battle$2d$planner$2f$battle$2d$planner$2d$panel$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["BattlePlannerPanel"], {
                drones: drones,
                selectedDrone: selectedPlanningDrone,
                onSelect: setSelectedPlanningDrone
            }, void 0, false, {
                fileName: "[project]/components/map-view.tsx",
                lineNumber: 1496,
                columnNumber: 9
            }, this),
            mode === "battle-planner" && selectedPlanningDrone && selectedTargetSensor && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$battle$2d$planner$2f$mission$2d$analysis$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["MissionAnalysis"], {
                drone: selectedPlanningDrone,
                sensor: selectedTargetSensor,
                onStartAttack: ()=>{
                    console.log("START ATTACK CLICKED");
                    if (!selectedPlanningDrone || !selectedTargetSensor) return;
                    console.log(selectedPlanningDrone);
                    console.log(selectedTargetSensor);
                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$droneCommand$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["sendDrone"])({
                        droneDbId: selectedPlanningDrone.droneId,
                        targetLatitude: selectedTargetSensor.latitude,
                        targetLongitude: selectedTargetSensor.longitude
                    });
                }
            }, void 0, false, {
                fileName: "[project]/components/map-view.tsx",
...
"[project]/app/(protected)/battlePlanner/page.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __turbopack_async_dependencies__ = __turbopack_handle_async_dependencies__([
    __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$map$2d$view$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__
]);
[__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$map$2d$view$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__] = __turbopack_async_dependencies__.then ? (await __turbopack_async_dependencies__)() : __turbopack_async_dependencies__;
"use client";
;
;
function DashboardPage() {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$map$2d$view$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["MapView"], {
        ...
        fileName: "[project]/app/(protected)/battlePlanner/page.tsx",
        lineNumber: 6,
        columnNumber: 10
    }, this);
}
...
//# sourceMappingURL=_d6bd4d41._.js.map
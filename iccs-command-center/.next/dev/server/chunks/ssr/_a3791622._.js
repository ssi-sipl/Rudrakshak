...
"[project]/app/(protected)/drones/[id]/edit/page.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function EditDronePage() {
    ...
    const { user, loading: Userloading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$context$2f$UserContext$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useUser"])();
    ...
    const fetchDroneDetails = async ()=>{
        ...
        setError(null);
        try {
            const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$droneos$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getDroneOSById"])(params.id, true); // Include area
            if (response.success && response.data) {
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$droneos$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["updateDroneOS"])(params.id, {
...
//# sourceMappingURL=_a3791622._.js.map
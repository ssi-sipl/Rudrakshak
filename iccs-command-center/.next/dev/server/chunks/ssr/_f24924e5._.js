...
(()=>{
    const e = new Error("Cannot find module '@/lib/simulator/droneSimulator'");
...
droneSimulator.registerFleet(mockDrones.map((d)=>({
        droneId: d.droneId,
        latitude: d.latitude,
...
async function sendDrone(payload) {
    await delay();
    console.log("🚁 SEND DRONE", payload);
    return {
        success: true,
        message: "Drone dispatched successfully",
        flightId: {
            id: `flight-${Date.now()}`,
            droneDbId: payload.droneDbId,
...
async function recallDrone(payload) {
    await delay();
    console.log("🏠 RECALL DRONE", payload);
    return {
        success: true,
        message: "Drone recalled successfully"
    };
}
async function dronePatrol(payload) {
    await delay();
    console.log("🛰️ PATROL", payload);
    return {
        success: true,
        message: "Drone patrol started"
    };
}
}),
...
//# sourceMappingURL=_f24924e5._.js.map
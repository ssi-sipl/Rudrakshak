...
function LoginPage() {
    ...
    async function handleSubmit(e) {
        ...
        setError("");
        setIsLoading(true);
        const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$auth$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["login"])(email, password);
        if (!res.success) {

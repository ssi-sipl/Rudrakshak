...
__turbopack_context__.s([
    ...
    ()=>createMediaConverter,
    "deleteMediaConverter",
    ()=>deleteMediaConverter,
    "getAllMediaConverters",
    ()=>getAllMediaConverters,
    "getMediaConverterById",
    ()=>getMediaConverterById,
    "updateMediaConverter",
    ()=>updateMediaConverter
]);
const API_BASE_URL = ("TURBOPACK compile-time value", "http://localhost:5001") || "http://localhost:5000";
async function getAllMediaConverters(params) {
    try {
        const queryParams = new URLSearchParams();
        if (params?.page) queryParams.append("page", params.page.toString());
        if (params?.limit) queryParams.append("limit", params.limit.toString());
        if (params?.search) queryParams.append("search", params.search);
        const url = `${API_BASE_URL}/api/mediaconverters${queryParams.toString() ? `?${queryParams.toString()}` : ""}`;
        const response = await fetch(url, {
            method: "GET",
            credentials: "include",
            cache: "no-store",
        ...
        if (!response.ok) {
            const errorData = await response.json();
            throw new Error(errorData.error || "Failed to fetch Media Converters");
        }
        return await response.json();
    } catch (error) {
        console.error("Error fetching Media Converters:", error);
        return {
            success: false,
            error: error instanceof Error ? error.message : "Failed to fetch Media Converters"
        };
    }
}
async function getMediaConverterById(id) {
    try {
        const response = await fetch(`${API_BASE_URL}/api/mediaconverters/${id}`, {
            method: "GET",
            credentials: "include",
            cache: "no-store",
            headers: {
        ...
        if (!response.ok) {
            const errorData = await response.json();
            throw new Error(errorData.error || "Failed to fetch Media Converter");
        }
        return await response.json();
    } catch (error) {
        console.error("Error fetching Media Converter:", error);
        return {
            success: false,
            error: error instanceof Error ? error.message : "Failed to fetch Media Converter"
        };
    }
}
async function createMediaConverter(data) {
    try {
        const response = await fetch(`${API_BASE_URL}/api/mediaconverters`, {
            method: "POST",
            credentials: "include",
            headers: {
                "Content-Type": "application/json"
        ...
        if (!response.ok) {
            const errorData = await response.json();
            throw new Error(errorData.error || "Failed to create Media Converter");
        }
        return await response.json();
    } catch (error) {
        console.error("Error creating Media Converter:", error);
        return {
            success: false,
            error: error instanceof Error ? error.message : "Failed to create Media Converter"
        };
    }
}
async function updateMediaConverter(id, data) {
    try {
        const response = await fetch(`${API_BASE_URL}/api/mediaconverters/${id}`, {
            method: "PUT",
            credentials: "include",
        ...
        if (!response.ok) {
            const errorData = await response.json();
            throw new Error(errorData.error || "Failed to update Media Converter");
        }
        return await response.json();
    } catch (error) {
        console.error("Error updating Media Converter:", error);
        return {
            success: false,
            error: error instanceof Error ? error.message : "Failed to update Media Converter"
        };
    }
}
async function deleteMediaConverter(id) {
    try {
        const response = await fetch(`${API_BASE_URL}/api/mediaconverters/${id}`, {
            method: "DELETE",
            credentials: "include",
        ...
        if (!response.ok) {
            const errorData = await response.json();
            throw new Error(errorData.error || "Failed to delete Media Converter");
        }
        return await response.json();
    } catch (error) {
        console.error("Error deleting Media Converter:", error);
        return {
            success: false,
            error: error instanceof Error ? error.message : "Failed to delete Media Converter"
        };
    }
}
}),
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: [
                ...
                !loading && areas.length === 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    className: "flex flex-col items-center justify-center rounded-lg border border-[#333] bg-[#222] py-12",
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$map$2d$pin$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__MapPin$3e$__["MapPin"], {
...
//# sourceMappingURL=_2c8c39fb._.js.map